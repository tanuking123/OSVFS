...
/// <c>--multipart-part-size</c>) against the S3 per-part bounds. Returns a
/// human-readable error string on violation, or null when the settings are
/// acceptable. Both inputs may be null, meaning "use the backend default".
/// </summary>
